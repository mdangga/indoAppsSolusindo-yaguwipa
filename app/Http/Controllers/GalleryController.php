...
class GalleryController extends Controller
{
    ...
    public function getDataTablesPhoto(Request $request)
    {
        ...
        return DataTables::of($gallery)
            ...
            <button class="cursor-pointer editBtn bg-blue-500 text-white px-2 py-1 rounded text-sm" data-id="' . e($row->id_gallery) . '">Edit</button>
            <button class="cursor-pointer deleteBtn bg-red-500 text-white px-2 py-1 rounded text-sm ml-2" data-id="' . e($row->id_gallery) . '">Hapus</button>
            </div>
        ';
            })
