...
@section('content')
    ...
    <form action="{{ $isEdit ? route('gallery.update', $gallery->id_gallery) : route('gallery.store') }}" method="POST"
            ...
            <div id="file-upload-container" class="flex flex-col h-full">
                <div id="file-upload"
                    ...
                    <div class="p-6 flex-grow flex flex-col justify-between">
                        <div class="space-y-1">
                            <div class="relative">
                                <input type="file" name="link" id="link-upload" accept="image/*" data-field="link"
                            ...
                            <div data-file-info="link" class="hidden bg-blue-50 border border-blue-200 rounded-lg p-3">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <div>
                                            <p data-file-name="link" class="text-sm font-medium text-blue-800"></p>
