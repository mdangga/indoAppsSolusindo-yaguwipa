...
<body class="bg-gray-50">
        ...
        <div class="bg-white border rounded-md border-gray-200 overflow-hidden">
            ...
            <div class="p-5 rounded-lg">
                <div class="table-container overflow-x-auto">
                    <table id="kerjaSamaTable" class="w-full border border-gray-300 ">
                        <thead>
                            <tr class="text-left">
                                <th>No</th>
                                <th>Nama</th>
    ...
    <script>
        $(document).ready(function() {
            let table = $('#kerjaSamaTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('kerjaSama.table') }}',
                ...
                language: {
                    ...
                    emptyTable: '<div class="text-center py-8"><i class="fas fa-inbox text-4xl text-gray-300 mb-4"></i><p class="text-gray-500">Belum ada data kerja sama</p></div>',
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'keterangan',
                        render: function(data) {
                            return data ? `<div class="line-clamp-2">${data}</div>` : '-';
                        }
                    },
                    {
                        data: 'kategori',
                    ...
                    },
                    {
                        ...
                        name: 'aksi',
                        render: function(data) {
                            const url = new URL(`{{ route('kerjaSama.detail', ':id') }}`.replace(
                                ':id', data));
                            return `
