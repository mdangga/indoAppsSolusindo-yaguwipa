...
@section('title', 'Admin - Gallery Photo')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#galleryTable').on('click', '.deleteBtn', function() {
                ...
                if (confirm('Apakah Anda yakin ingin menghapus photo ini?')) {
                    // Show loading state
                    ...
                    fetch(`/admin/gallery/destroy/${id}`, {
                        ...
                        .then(response => {
                            if (response.redirected || response.ok) {
                                table.ajax.reload();
                                showNotification('Photo berhasil dihapus!', 'success');
                            } else {
                                throw new Error('Gagal menghapus photo');
                            }
                        })
                        .catch(error => {
                            console.error(error);
