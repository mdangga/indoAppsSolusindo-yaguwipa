...
<body>
    <div class="min-h-screen bg-gray-50">
        <!-- Header -->
        <x-user.header-user :user="$user" :randomBg="$randomBg" :profilePath="$profilePath" :title="'Edit Profile'" :description="'Kelola informasi akun Anda'" />
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            <form id="deleteAccountForm" method="POST">
                                ...
                                <div class="flex justify-end space-x-3">
                                    ...
                                    <button id="submitButton" type="submit"
                                        class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 text-sm font-medium">nonaktif
                                    </button>
                                </div>
                            </form>
                        </div>
            ...
            <script>
                ...
                function showDeleteModal(actionType) {
                    ...
                    const usernameInput = document.getElementById('usernameDelete');
