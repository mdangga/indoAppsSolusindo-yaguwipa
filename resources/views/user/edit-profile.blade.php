        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="space-y-8">
                    ...
                    <div class="px-6 py-6">
                        <form action="{{ route('edit-profile.photo') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex items-center space-x-6">
                                ...
                                <div class="flex-1">
                                    <input type="file" name="profile_path" accept="image/*"
                ...
                <div id="deleteModal"
                    ...
                    <div class="bg-white rounded-lg shadow-lg max-w-md w-full">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold text-red-900 mb-2">Konfirmasi Nonaktifkan Akun</h3>
                            <p class="text-sm text-gray-600 mb-4">Masukkan password Anda untuk mengonfirmasi
                                penonaktifan akun.</p>
            ...
            <script>
                ...
                document.getElementById('deleteAccountForm').addEventListener('submit', function(e) {
                    if (!confirm('Apakah Anda yakin ingin menonaktifkan akun Anda?')) {
                        e.preventDefault();
                    }
                });
            </script>
