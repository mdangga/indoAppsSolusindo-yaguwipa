        ...
        <div class="max-w-7xl mx-auto">
                        ...
                        <a href="{{ route('berita.slug', $pop->slug) }}"
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-400 flex items-center gap-3">
                                    ...
                                    <span>•</span>
                                    <span>{{ $pop->read_time ?? '5' }} min read</span>
                                </div>
            ...
            <section class="mt-13">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                    @foreach ($beritaPopuler as $berita)
                        <a href="{{ route('berita.slug', $berita->slug) }}" class="group">
                            <!-- Gambar -->
                            <div class="relative w-full h-[150px] overflow-hidden  shadow-sm">
                                <img src="{{ $berita->thumbnail ? asset('storage/' . $berita->thumbnail) : asset('images/no-image.png') }}"
                                    alt="{{ $berita->judul }}"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="text-xs text-gray-500 mt-1">
                                    ...
                                    {{ $berita->KategoriNewsEvent->nama ?? 'Tanpa Kategori' }}
                                </div>
                            </div>
                        </a>
                    @endforeach
            ...
            <section class="py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <h1 class="text-3xl font-extrabold text-gray-800 mb-6">Berita Terbaru</h1>
                    @foreach ($beritaPopulerMingguan as $index => $item)
                        <div
                            class="flex flex-row gap-5 items-center 
                {{ $index !== count($beritaPopulerMingguan) - 1 ? 'border-b border-gray-200 pb-6' : '' }}">
                            <!-- Gambar Thumbnail -->
