        ...
        <div class="relative px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-3">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button class="p-2 text-gray-500 hover:text-pink-600 transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path fill="currentColor"
            ...
            <div class="grid grid-cols-[auto_1fr] items-center gap-2 mb-6 pb-4 border-b border-gray-200">
                <img src="img-placeholder.webp" alt="Foto profil Pande Made Angga Murdika"
                    class="w-10 h-10 rounded-full object-cover">

                <div class="flex flex-col">
                    <span class="font-medium text-gray-900">Pande Made Angga Murdika</span>
            ...
            <div class="flex flex-wrap gap-2 mt-4">
                <span class="px-3 py-1 text-sm bg-gray-100 text-black hover:bg-black hover:text-white cursor-default">yayasan</span>
                <span class="px-3 py-1 text-sm bg-gray-100 text-black hover:bg-black hover:text-white cursor-default">guna</span>
                <span class="px-3 py-1 text-sm bg-gray-100 text-black hover:bg-black hover:text-white cursor-default">widya</span>
                <span class="px-3 py-1 text-sm bg-gray-100 text-black hover:bg-black hover:text-white cursor-default">paramesti</span>
                <span class="px-3 py-1 text-sm bg-gray-100 text-black hover:bg-black hover:text-white cursor-default">donasi</span>
            </div>
