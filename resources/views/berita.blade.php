...
<body>
    ...
    <main>
        ...
        <div class="relative top-0 pt-32 lg:pt-40 pb-10">
            <!-- container headline -->
            <div class="relative px-6 lg:px-8 max-w-6xl mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="flex justify-between items-center mb-3">
                            <div class="flex items-center space-x-2 text-gray-600">
                                ...
                                <span
                                    class="text-sm">{{ \Carbon\Carbon::parse($berita->tanggal_publish)->diffForHumans() }}</span>
                            </div>
                        ...
                        @if ($berita_terkait->isNotEmpty())
                            <div class="w-full mt-6">
                                <h3 class="text-md font-semibold text-gray-700 mb-2">Baca juga:</h3>
                    ...
                    <aside class="space-y-6">
                        <div class="flex items-center gap-4 mb-4">
                            <h2 class="text-xl font-semibold text-gray-800 whitespace-nowrap">Berita Populer</h2>
                        ...
                        <!-- Tag Populer di bawah berita -->
                        <div class="mt-6">
                            <div class="flex items-center gap-4 mb-4">
                                <h3 class="text-lg font-semibold text-gray-800 whitespace-nowrap">Tag Populer</h3>
                                <div class="flex-grow border-b-2 border-gray-500"></div>
                            </div>
                            <div class="flex flex-wrap gap-2">
                                @php
                                    $tags = collect($berita_populer)
                                        ->pluck('keyword')
