        ...
        <div class="relative px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-3">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($berita->judul) }}" class="p-2 text-gray-500 hover:text-black transition-colors">
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" class="p-2 text-gray-500 hover:text-blue-800 transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
