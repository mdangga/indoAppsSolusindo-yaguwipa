...
@section('title', $program->nama . ' - Program Yayasan')
...
@section('content')
    ...
    <main class="bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 pt-32 pb-10">
                ...
                <section class="mt-8" data-aos="fade-up">
                    ...
                    <div class="bg-white rounded-xl shadow-md p-8">
                        ...
                        @forelse ($campaigns as $item)
                            <div class="{{ $loop->last ? '' : 'border-b border-gray-200 pb-6 mb-6' }} ">
                                <a href="{{ route('campaign.slug', $item->slug) }}"
