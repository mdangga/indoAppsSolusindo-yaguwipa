...
<body>
   ...
   <div class="px-4 sm:px-6 lg:px-14 py-20">
        ...
        <div class=" sm:flex-row pb-10 gap-4 text-center">
            ...
            <p class="mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque harum pariatur, deserunt odio animi ducimus temporibus rem dolorum aut omnis!</p>
        </div>
