...
<footer class="bg-gray-900 text-white">
    <div class="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 pt-10 px-6">
        <!-- Kiri: Info Yayasan -->
        ...
        <!-- Kanan: Map -->
        <div class="relative max-w-full h-[250px] border-0 [&>iframe]:w-full [&>iframe]:h-full [&>iframe]:rounded-md">
            {!! $site['yayasanProfile']->map !!}
        </div>
    </div>

    <div class="bg-[#182238] text-white mt-5">
        <div class="max-w-screen-xl mx-auto p-4 grid grid-cols-1 md:grid-cols-2 md:gap-6">
