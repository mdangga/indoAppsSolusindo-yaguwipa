    ...
    <div class="flex-1 overflow-y-auto custom-scroll px-3 pb-4">
        <ul class="space-y-2 font-medium pt-4">
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-gray-200 transition duration-75 rounded-lg group hover:bg-[#535c66]"
                    onclick="toggleDropdown('kerjaSama')">
                    <svg class="shrink-0 w-5 h-5 text-gray-200 transition duration-75 group-hover:text-gray-200"
                    ...
                    <svg class="w-3 h-3 dropdown-arrow" id="kerjaSama-arrow" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
                    </svg>
                </button>
                <ul id="kerjaSama-content" class="dropdown-content">
                    <li class="py-1">
                    ...
                    <li class="py-1">
                        <a href="{{ route('admin.kerjaSama') }}"
                            class="flex items-center w-full p-2 text-gray-200 transition duration-75 rounded-lg pl-11 group hover:bg-[#535c66] font-normal">Kerja
                            Sama</a>
                    </li>
                </ul>
            </li>
